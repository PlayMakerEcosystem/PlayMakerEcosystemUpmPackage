...
*/
	...
	public class Item {
		...
		#region Enums
		public enum ItemTypes {Action,Template,Sample,Package,ActionPackage};
		...
		*/
		...
		public Hashtable DocDescription;
		...
		public void ProcessMetaData()
		{
			...
			if (metaData!=null)
			{
				...
				if (metaData.ContainsKey("documentation"))
				{
					DocDescription = (Hashtable)metaData["documentation"];

					if (DocDescription != null)
					{
						_hasDocumentation = true;
					}
				}
			}
		}
		...
		IEnumerator LoadDocumentationImage()
		{
			...
			if (string.IsNullOrEmpty(DocumentationImageUrl))
			{
				...
				if (_Type == ItemTypes.Action)
				{
					...
					if (_Name.EndsWith("action.txt"))
					{
						screenshotFileName = _Name.Replace(".action.txt", ".png");
						DocumentationImageUrl = string.Format(__ActionScreenShotUrlFormat__, _RepositoryFullNamePath, skin, screenshotFileName);
					}
					else
					{
			...
			if (EcosystemBrowser.IsDebugOn)	Debug.Log("_RepositoryFullNamePath:"+_RepositoryFullNamePath);
